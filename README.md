...
Desenvolvedor **Full Stack** em formação | Criando soluções completas com foco em aprendizado contínuo e impacto real.

---

## 🚀 Sobre mim
- 👨‍💻 Estudante de **Análise e Desenvolvimento de Sistemas**
- 🔧 Desenvolvedor **Full Stack em formação**, atuando com **Front-End e Back-End**
- 🌱 Estudando **HTML5, CSS3, JavaScript, TypeScript, React (Vite) e .NET (C#)**
- 💡 Interesse em criar soluções práticas, organizadas e escaláveis
- 🎯 Objetivo: evoluir como **Full Stack Developer**, contribuindo em projetos reais
...
- 🌐 **Portfólio Front-End**  
  🔗 https://github.com/RodrigoStukas/portfolio-front-end-rodrigo

- 📇 **Projeto DevLinks**  
  🔗 https://github.com/RodrigoStukas/ProjetoRodrigo
